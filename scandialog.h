...
public:
  explicit Scanner(QObject *parent = 0) : QThread(parent), stopped(false) {}
  ...
  void run() {
    ...
    QDirIterator iterator(scanDir, isRecursive ? QDirIterator::Subdirectories
  ...
  void setRecursive(bool rec) { isRecursive = rec; }

  void setDir(const QDir &dir) { scanDir = dir; }

  void setText(const QString &t) { text = t; }

  QStringList files() const { return fileList; }

  QStringList lines() const { return numlineList; }
