...
export default function EditorToolbar(props: Props) {
    ...
    const shouldShowShareButton = () => {
        return !(process.env.NODE_ENV === 'production' && window.location.host.startsWith('localhost'));
    }

    return (
        <ToolbarShell>
            <ToolbarTitleShell>
                <a href="/project.html"><img src={require('../assets/feather.svg')} className={css(styles.logo)}/></a>
                <EditorTitle name={name} saveStatus={saveStatus} onSubmitTitle={onSubmitTitle} />
            </ToolbarTitleShell>
            <div className={css(styles.buttons)}>
                {shouldShowShareButton() ? <IconButton
                    responsive
