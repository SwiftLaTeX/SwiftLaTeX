...
import { VISIBILITY_MEDIA_QUERY } from './Preview/DevicePreview';
  ...
  return (
    <FooterShell type={isErrorFatal ? 'error' : null}>
      ...
      <MenuButton
        ...
        label={
          <React.Fragment>
            <span className={css(styles.buttonLabel)}>Engine</span>
          </React.Fragment>
        }
        content={
          <div className={css(styles.devicePane)}>
            {
              <React.Fragment>
                ...
                <div className={css(styles.buttonItem, styles.buttonItemDevicePane)}>
                  <IconButton title={`Update changes`} label="Force Recompilation" onClick={onSendCode}>
