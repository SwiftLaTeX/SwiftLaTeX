...
QVector<ParenthesisInfo *> BlockData::parentheses() { return m_parentheses; }
QVector<LatexBlockInfo *> BlockData::latexblocks() { return m_latexblocks; }
