...
QKeySequence KeySequenceDialog::keySequence() const { return m_keySequence; }

int KeySequenceDialog::translateModifiers(Qt::KeyboardModifiers state,
...
void KeySequenceDialog::keyReleaseEvent(QKeyEvent *e) { ui.lineEdit->event(e); }
