...
class MonacoEditor extends React.Component<Props> {
    ...
    componentDidMount() {
        ...
        // @ts-ignore
        this._outerResizeObserver = new ResizeObserver((_) => this._handleResize());

        // @ts-ignore
        this._outerResizeObserver!.observe(this._outerNode.current);
    }
    ...
    componentWillUnmount() {
        ...
        // @ts-ignore
        this._outerResizeObserver && this._outerResizeObserver.disconnect();
    }
    ...
    _outerNode = React.createRef<HTMLDivElement>();
    _outerResizeObserver = undefined;

    render() {
        return (
            <div className={css(styles.container)} ref={this._outerNode}>
