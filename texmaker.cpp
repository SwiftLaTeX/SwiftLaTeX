...
// MacSupport::addFullscreen(this);
  ...
  LeftPanelToolBarBis->setSizePolicy(QSizePolicy::Expanding,
  ...
  StructureTreeWidget->header()->setHorizontalScrollMode(
      QAbstractItemView::ScrollPerPixel);

  StructureTreeWidget->header()->setSectionResizeMode(
  ...
  connect(StructureTreeWidget, SIGNAL(itemClicked(QTreeWidgetItem *, int)),
          SLOT(ClickedOnStructure(QTreeWidgetItem *, int)));

  connect(LeftPanelToolBar->addAction(getIcon(":/images/structure.png"),
                                      tr("Structure")),
          SIGNAL(triggered()), this, SLOT(ShowStructure()));
  ...
  connect(OpenedFilesListWidget, SIGNAL(itemClicked(QListWidgetItem *)), this,
          SLOT(OpenedFileActivated(QListWidgetItem *)));
  OpenedFilesListWidget->viewport()->setStyleSheet(
      Theme::viewportDarkStyleSheet);
  OpenedFilesListWidget->setStyleSheet(Theme::listwidgetStyleSheet);
  // connect(LeftPanelToolBar->addAction(QIcon(":/images/opened.png"),tr("Opened
  // Files")), SIGNAL(triggered()), this, SLOT(ShowOpenedFiles()));
  ...
  connect(RelationListWidget, SIGNAL(itemClicked(QTableWidgetItem *)), this,
          SLOT(InsertSymbol(QTableWidgetItem *)));
  relationAct =
      new QAction(getIcon(":/images/math1.png"), tr("Relation symbols"), this);
  connect(relationAct, SIGNAL(triggered()), this, SLOT(ShowRelation()));
  LeftPanelToolBar->addAction(relationAct);
  connect(RelationListWidget->addAct, SIGNAL(triggered()), this,
          SLOT(InsertFavoriteSymbols()));
  ...
  connect(ArrowListWidget, SIGNAL(itemClicked(QTableWidgetItem *)), this,
          SLOT(InsertSymbol(QTableWidgetItem *)));
  arrowAct =
      new QAction(getIcon(":/images/math2.png"), tr("Arrow symbols"), this);
  connect(arrowAct, SIGNAL(triggered()), this, SLOT(ShowArrow()));
  LeftPanelToolBar->addAction(arrowAct);
  connect(ArrowListWidget->addAct, SIGNAL(triggered()), this,
          SLOT(InsertFavoriteSymbols()));
  ...
  connect(MiscellaneousListWidget, SIGNAL(itemClicked(QTableWidgetItem *)),
          this, SLOT(InsertSymbol(QTableWidgetItem *)));
  miscAct = new QAction(getIcon(":/images/math3.png"),
                        tr("Miscellaneous symbols"), this);
  connect(miscAct, SIGNAL(triggered()), this, SLOT(ShowMisc()));
  LeftPanelToolBar->addAction(miscAct);
  connect(MiscellaneousListWidget->addAct, SIGNAL(triggered()), this,
          SLOT(InsertFavoriteSymbols()));
  ...
  connect(DelimitersListWidget, SIGNAL(itemClicked(QTableWidgetItem *)), this,
          SLOT(InsertSymbol(QTableWidgetItem *)));
  ...
  connect(DelimitersListWidget->addAct, SIGNAL(triggered()), this,
          SLOT(InsertFavoriteSymbols()));
  ...
  connect(GreekListWidget, SIGNAL(itemClicked(QTableWidgetItem *)), this,
          SLOT(InsertSymbol(QTableWidgetItem *)));
  greekAct =
      new QAction(getIcon(":/images/math5.png"), tr("Greek letters"), this);
  connect(greekAct, SIGNAL(triggered()), this, SLOT(ShowGreek()));
  LeftPanelToolBar->addAction(greekAct);
  connect(GreekListWidget->addAct, SIGNAL(triggered()), this,
          SLOT(InsertFavoriteSymbols()));
  ...
  connect(MostUsedListWidget, SIGNAL(itemClicked(QTableWidgetItem *)), this,
          SLOT(InsertSymbol(QTableWidgetItem *)));
  usedAct =
      new QAction(getIcon(":/images/math6.png"), tr("Most used symbols"), this);
  ...
  connect(FavoriteListWidget, SIGNAL(itemClicked(QTableWidgetItem *)), this,
          SLOT(InsertSymbol(QTableWidgetItem *)));
  favAct =
      new QAction(getIcon(":/images/math7.png"), tr("Favorites symbols"), this);
  ...
  connect(FavoriteListWidget->remAct, SIGNAL(triggered()), this,
          SLOT(RemoveFavoriteSymbols()));
  LeftPanelStackedWidget->addWidget(FavoriteListWidget);

  LeftPanelToolBar->addSeparator();

  leftrightWidget = new XmlTagsListWidget(LeftPanelStackedWidget,
                                          ":/tags/leftright_tags.xml");
  leftrightWidget->setFrameStyle(QFrame::NoFrame);
  connect(leftrightWidget, SIGNAL(itemClicked(QListWidgetItem *)), this,
          SLOT(InsertXmlTag(QListWidgetItem *)));
  leftrightAct =
      new QAction(getIcon(":/images/leftright.png"), "left/right", this);
  ...
  connect(usertagsListWidget, SIGNAL(itemClicked(QListWidgetItem *)), this,
          SLOT(InsertUserElement(QListWidgetItem *)));
  ...
  connect(usertagsListWidget->remAct, SIGNAL(triggered()), this,
          SLOT(RemoveUserTag()));
  connect(usertagsListWidget->addAct, SIGNAL(triggered()), this,
          SLOT(AddUserTag()));
  connect(usertagsListWidget->changeAct, SIGNAL(triggered()), this,
          SLOT(ChangeUserTag()));
  connect(usertagsListWidget, SIGNAL(posChanged()), this,
          SLOT(UpdateUserTag()));
  ...
  PsListWidget =
      new XmlTagsListWidget(LeftPanelStackedWidget, ":/tags/pstricks_tags.xml");
  PsListWidget->setFrameStyle(QFrame::NoFrame);
  connect(PsListWidget, SIGNAL(itemClicked(QListWidgetItem *)), this,
          SLOT(InsertXmlTag(QListWidgetItem *)));
  pstricksAct = new QAction(getIcon(":/images/pstricks.png"),
                            tr("Pstricks Commands"), this);
  connect(pstricksAct, SIGNAL(triggered()), this, SLOT(ShowPstricks()));
  if (showPstricks)
    LeftPanelToolBar->addAction(pstricksAct);
  LeftPanelStackedWidget->addWidget(PsListWidget);

  MpListWidget =
      new XmlTagsListWidget(LeftPanelStackedWidget, ":/tags/metapost_tags.xml");
  MpListWidget->setFrameStyle(QFrame::NoFrame);
  connect(MpListWidget, SIGNAL(itemClicked(QListWidgetItem *)), this,
          SLOT(InsertXmlTag(QListWidgetItem *)));
  mpAct = new QAction(getIcon(":/images/metapost.png"), tr("MetaPost Commands"),
                      this);
  connect(mpAct, SIGNAL(triggered()), this, SLOT(ShowMplist()));
  if (showMp)
    LeftPanelToolBar->addAction(mpAct);
  LeftPanelStackedWidget->addWidget(MpListWidget);

  tikzWidget =
      new XmlTagsListWidget(LeftPanelStackedWidget, ":/tags/tikz_tags.xml");
  tikzWidget->setFrameStyle(QFrame::NoFrame);
  connect(tikzWidget, SIGNAL(itemClicked(QListWidgetItem *)), this,
          SLOT(InsertXmlTag(QListWidgetItem *)));
  tikzAct =
      new QAction(getIcon(":/images/tikz.png"), tr("Tikz Commands"), this);
  connect(tikzAct, SIGNAL(triggered()), this, SLOT(ShowTikz()));
  if (showTikz)
    LeftPanelToolBar->addAction(tikzAct);
  LeftPanelStackedWidget->addWidget(tikzWidget);

  asyWidget = new XmlTagsListWidget(LeftPanelStackedWidget,
                                    ":/tags/asymptote_tags.xml");
  asyWidget->setFrameStyle(QFrame::NoFrame);
  connect(asyWidget, SIGNAL(itemClicked(QListWidgetItem *)), this,
          SLOT(InsertXmlTag(QListWidgetItem *)));
  asyAct = new QAction(getIcon(":/images/asymptote.png"),
                       tr("Asymptote Commands"), this);
  connect(asyAct, SIGNAL(triggered()), this, SLOT(ShowAsy()));
  if (showAsy)
    LeftPanelToolBar->addAction(asyAct);
  ...
  connect(LeftPanelToolBar, SIGNAL(customContextMenuRequested(const QPoint &)),
          this, SLOT(customContentsMenuStructure(const QPoint &)));
  ...
  titleLeftPanel =
      new DropShadowLabel(tr("Structure").toUpper(), LeftPanelToolBarBis);
  ...
  connect(OutputTableWidget, SIGNAL(itemClicked(QTableWidgetItem *)), this,
          SLOT(ClickedOnLogLine(QTableWidgetItem *)));
  ...
  connect(OutputTextEdit, SIGNAL(clickonline(int)), this,
          SLOT(ClickedOnOutput(int)));
  ...
  scriptList.clear();
  foreach (QFileInfo qmScriptInfo,
           transdir.entryInfoList(QStringList("*.tms"),
                                  QDir::Files | QDir::Readable,
                                  QDir::Name | QDir::IgnoreCase)) {
  ...
  Act = new QAction(getIcon(":/images/sectioning.png"),
                    "part/chapter/section...", this);
  ...
  connect(Act, SIGNAL(triggered()), this,
          SLOT(InsertWithSelectionFromAction()));
  centralToolBar->addAction(Act);
  ...
  emphasisAct =
      new QAction(getIcon(":/images/text_emphasis.png"), "Emphasis", this);
  emphasisAct->setData("\\emph{/}/6/0");
  connect(emphasisAct, SIGNAL(triggered()), this,
          SLOT(InsertWithSelectionFromAction()));
  if (showEmphasis)
    centralToolBar->addAction(emphasisAct);
  ...
  newlineAct =
      new QAction(getIcon(":/images/newline.png"), tr("New line"), this);
  newlineAct->setData("\\\\\n/0/1/The \\newline command breaks the line right "
                      "where it is. It can only be used in paragraph mode.");
  connect(newlineAct, SIGNAL(triggered()), this, SLOT(InsertFromAction()));
  if (showNewline)
    centralToolBar->addAction(newlineAct);

  centralToolBar->addSeparator();

  mathmodeAct = new QAction(getIcon(":/images/mathmode.png"), "$...$", this);
  mathmodeAct->setData("$  $/2/0/The math environment can be used in both "
                       "paragraph and LR mode");
  connect(mathmodeAct, SIGNAL(triggered()), this, SLOT(InsertFromAction()));
  if (showMathmode)
    centralToolBar->addAction(mathmodeAct);

  indiceAct =
      new QAction(getIcon(":/images/indice.png"), "_{} - subscript", this);
  indiceAct->setData("_{}/2/0/ ");
  connect(indiceAct, SIGNAL(triggered()), this, SLOT(InsertFromAction()));
  if (showIndice)
    centralToolBar->addAction(indiceAct);

  puissanceAct =
      new QAction(getIcon(":/images/puissance.png"), "^{} - superscript", this);
  puissanceAct->setData("^{}/2/0/ ");
  connect(puissanceAct, SIGNAL(triggered()), this, SLOT(InsertFromAction()));
  if (showPuissance)
    centralToolBar->addAction(puissanceAct);

  smallfracAct =
      new QAction(getIcon(":/images/smallfrac.png"), "\\frac{}{}", this);
  smallfracAct->setData("\\frac{}{}/6/0/ ");
  connect(smallfracAct, SIGNAL(triggered()), this, SLOT(InsertFromAction()));
  if (showSmallfrac)
    centralToolBar->addAction(smallfracAct);
  ...
  if (showDfrac)
    centralToolBar->addAction(dfracAct);
  ...
  if (showRacine)
    centralToolBar->addAction(racineAct);
  ...
  connect(centralToolBar, SIGNAL(customContextMenuRequested(const QPoint &)),
          this, SLOT(customContentsMenuMain(const QPoint &)));
  ...
  centralToolBarBis->setSizePolicy(QSizePolicy::Expanding,
                                   QSizePolicy::Minimum);
  ...
  ToggleDocAct = new QAction(
      getIcon(":/images/toggle.png"),
      tr("Toggle between the master document and the current document") +
          " (CTRL+SHIFT+F2)",
      this);
  ...
  Act = new QAction(getIcon(":/images/errorprev.png"), tr("Previous Document"),
                    this);
  ...
  Act =
      new QAction(getIcon(":/images/errornext.png"), tr("Next Document"), this);
  ...
  connect(comboFiles, SIGNAL(activated(int)), this,
          SLOT(listSelectionActivated(int)));
  ...
  centralToolBarBis->addSeparator();
  Act = new QAction(getIcon(":/images/bookmark1.png"),
                    tr("Click to jump to the bookmark"), this);
  connect(Act, SIGNAL(triggered()), this, SLOT(gotoBookmark1()));
  centralToolBarBis->addAction(Act);
  Act = new QAction(getIcon(":/images/bookmark2.png"),
                    tr("Click to jump to the bookmark"), this);
  connect(Act, SIGNAL(triggered()), this, SLOT(gotoBookmark2()));
  centralToolBarBis->addAction(Act);
  Act = new QAction(getIcon(":/images/bookmark3.png"),
                    tr("Click to jump to the bookmark"), this);
  ...
  connect(EditorView, SIGNAL(currentChanged(int)), this,
          SLOT(UpdateStructure()));
  ...
  connect(splitter2, SIGNAL(splitterMoved(int, int)), this,
...
void Texmaker::setupMenus() {
  ...
  if (gtkEnv)
    Act = new QAction(
        QIcon::fromTheme("document-new", QIcon(":/images/filenew.png")),
        tr("New"), this);
  else
    Act = new QAction(getIcon(":/images/filenew.png"), tr("New"), this);
  ...
  if (gtkEnv)
    Act = new QAction(
        QIcon::fromTheme("document-open", QIcon(":/images/fileopen.png")),
        tr("Open"), this);
  else
    Act = new QAction(getIcon(":/images/fileopen.png"), tr("Open"), this);
  ...
  if (gtkEnv)
    SaveAct = new QAction(
        QIcon::fromTheme("document-save", QIcon(":/images/filesave.png")),
        tr("Save"), this);
  else
    SaveAct = new QAction(getIcon(":/images/filesave.png"), tr("Save"), this);
  ...
  if (gtkEnv)
    ...
    Act = new QAction(getIcon(":/images/exit.png"), tr("Exit"), this);
  ...
  if (gtkEnv)
    UndoAct =
        new QAction(QIcon::fromTheme("edit-undo", QIcon(":/images/undo.png")),
                    tr("Undo"), this);
  else
    UndoAct = new QAction(getIcon(":/images/undo.png"), tr("Undo"), this);
  ...
  if (gtkEnv)
    RedoAct =
        new QAction(QIcon::fromTheme("edit-redo", QIcon(":/images/redo.png")),
                    tr("Redo"), this);
  else
    RedoAct = new QAction(getIcon(":/images/redo.png"), tr("Redo"), this);
  ...
  if (gtkEnv)
    CopyAct = new QAction(
        QIcon::fromTheme("edit-copy", QIcon(":/images/editcopy.png")),
        tr("Copy"), this);
  else
    CopyAct = new QAction(getIcon(":/images/editcopy.png"), tr("Copy"), this);
  ...
  if (gtkEnv)
    CutAct =
        new QAction(QIcon::fromTheme("edit-cut", QIcon(":/images/editcut.png")),
                    tr("Cut"), this);
  else
    CutAct = new QAction(getIcon(":/images/editcut.png"), tr("Cut"), this);
  ...
  if (gtkEnv)
    PasteAct = new QAction(
        QIcon::fromTheme("edit-paste", QIcon(":/images/editpaste.png")),
        tr("Paste"), this);
  else
    PasteAct =
        new QAction(getIcon(":/images/editpaste.png"), tr("Paste"), this);
  ...
  Act = new QAction(getIcon(":/images/errornext.png"), tr("Next LaTeX Error"),
                    this);
  ...
  Act->setData("\\begin{document}\n\n\\end{document}/0/1/Text is allowed only "
               "between \\begin{document} and \\end{document}.");
  connect(Act, SIGNAL(triggered()), this, SLOT(InsertFromAction()));
  latex1Menu->addAction(Act);
  Act = new QAction("\\author{}", this);
  Act->setData("\\author{}/8/0/\\author{names}\nThe \\author command declares "
               "the author(s), where names is a list of authors separated by "
               "\\and commands.");
  connect(Act, SIGNAL(triggered()), this, SLOT(InsertFromAction()));
  latex1Menu->addAction(Act);
  Act = new QAction("\\title{}", this);
  Act->setData("\\title{}/7/0/\\title{text}\nThe \\title command declares text "
               "to be the title.");
  connect(Act, SIGNAL(triggered()), this, SLOT(InsertFromAction()));
  latex1Menu->addAction(Act);
  Act = new QAction("\\maketitle", this);
  Act->setData("\\maketitle/10/0/This command generates a title on a separate "
               "title page\n- except in the article class, where the title "
               "normally goes at the top of the first page.");
  connect(Act, SIGNAL(triggered()), this, SLOT(InsertFromAction()));
  latex1Menu->addAction(Act);
  Act = new QAction("\\tableofcontents", this);
  Act->setData("\\tableofcontents/16/0/Put this command where you want the "
  ...
  Act = new QAction(getIcon(":/images/text_center.png"),
                    "\\begin{center} [selection]", this);
  Act->setData("\\begin{center}\n/\n\\end{center}/0/1");
  connect(Act, SIGNAL(triggered()), this,
          SLOT(InsertWithSelectionFromAction()));
  latex12Menu->addAction(Act);
  Act = new QAction(getIcon(":/images/text_left.png"),
                    "\\begin{flushleft} [selection]", this);
  Act->setData("\\begin{flushleft}\n/\n\\end{flushleft}/0/1");
  connect(Act, SIGNAL(triggered()), this,
          SLOT(InsertWithSelectionFromAction()));
  latex12Menu->addAction(Act);
  Act = new QAction(getIcon(":/images/text_right.png"),
                    "\\begin{flushright}  [selection]", this);
  Act->setData("\\begin{flushright}\n/\n\\end{flushright}/0/1");
  connect(Act, SIGNAL(triggered()), this,
          SLOT(InsertWithSelectionFromAction()));
  latex12Menu->addAction(Act);
  ...
  Act->setData("\\begin{itemize}\n\\item \n\\end{itemize}/6/1/The itemize "
               "environment produces a 'bulleted' list.\nEach item of an "
               "itemized list begins with an \\item command.");
  connect(Act, SIGNAL(triggered()), this, SLOT(InsertFromAction()));
  latex13Menu->addAction(Act);
  Act = new QAction(getIcon(":/images/enumerate.png"), "\\begin{enumerate}",
                    this);
  Act->setData("\\begin{enumerate}\n\\item \n\\end{enumerate}/6/1/The "
               "enumerate environment produces a numbered list.\nEach item of "
               "an enumerated list begins with an \\item command.");
  connect(Act, SIGNAL(triggered()), this, SLOT(InsertFromAction()));
  latex13Menu->addAction(Act);
  Act = new QAction("\\begin{description}", this);
  Act->setData("\\begin{description}\n\\item[]\n\\end{description}/6/1/The "
               "description environment is used to make labelled lists.\nEach "
               "item of the list begins with an \\item[label] command.\n");
  connect(Act, SIGNAL(triggered()), this, SLOT(InsertFromAction()));
  latex13Menu->addAction(Act);
  ...
  Act->setData(
      ...
      "is a piece of text that is inserted in a box to form the label.\nThe "
      "{spacing} argument contains commands to change the spacing parameters "
  ...
  Act = new QAction(getIcon(":/images/text_italic.png"),
                    "\\textit - Italics  [selection]", this);
  ...
  connect(Act, SIGNAL(triggered()), this,
          SLOT(InsertWithSelectionFromAction()));
  latex14Menu->addAction(Act);
  Act = new QAction(getIcon(":/images/text_bold.png"),
                    "\\textbf - Boldface  [selection]", this);
  ...
  connect(Act, SIGNAL(triggered()), this,
          SLOT(InsertWithSelectionFromAction()));
  latex14Menu->addAction(Act);
  Act = new QAction(getIcon(":/images/text_emphasis.png"),
                    "\\emph - Emphasis  [selection]", this);
  ...
  Act->setData("\\begin{tabbing}\n\n\\end{tabbing}/0/1/\\begin{tabbing}\ntext "
               "\\= more text \\= still more text \\= last text \\\\\nsecond "
               "row \\>  \\> more \\\\\n\\end{tabbing}");
  connect(Act, SIGNAL(triggered()), this, SLOT(InsertFromAction()));
  ...
  Act->setData(
      "\\multicolumn{}{}{} /13/0/\\multicolumn{cols}{pos}{text}\ncol, "
      "specifies the number of columns to span.\npos specifies the formatting "
      "of the entry: c for centred, l for flushleft, r for flushright.\ntext "
      "specifies what text is to make up the entry.");
  connect(Act, SIGNAL(triggered()), this, SLOT(InsertFromAction()));
  latex15Menu->addAction(Act);
  Act = new QAction("\\hline", this);
  Act->setData("\\hline /7/0/The \\hline command draws a horizontal line the "
               "width of the table.");
  connect(Act, SIGNAL(triggered()), this, SLOT(InsertFromAction()));
  latex15Menu->addAction(Act);
  Act = new QAction("\\vline", this);
  Act->setData("\\vline /7/0/The \\vline command draws a vertical line "
               "extending the full height and depth of its row.");
  connect(Act, SIGNAL(triggered()), this, SLOT(InsertFromAction()));
  latex15Menu->addAction(Act);
  Act = new QAction("\\cline", this);
  Act->setData(
      "\\cline{-} /7/0/The \\cline{i-j} command draws horizontal lines across "
      "the columns specified, beginning in column i and ending in column j");
  connect(Act, SIGNAL(triggered()), this, SLOT(InsertFromAction()));
  latex15Menu->addAction(Act);
  ...
  Act->setData("\\linebreak /11/0/The \\linebreak command tells LaTeX to break "
               "the current line at the point of the command.");
  connect(Act, SIGNAL(triggered()), this, SLOT(InsertFromAction()));
  latex16Menu->addAction(Act);
  Act = new QAction("\\pagebreak", this);
  Act->setData("\\pagebreak /11/0/The \\pagebreak command tells LaTeX to break "
               "the current page at the point of the command.");
  connect(Act, SIGNAL(triggered()), this, SLOT(InsertFromAction()));
  latex16Menu->addAction(Act);
  Act = new QAction("\\bigskip", this);
  Act->setData(
      "\\bigskip /9/0/The \\bigskip command adds a 'big' vertical space.");
  connect(Act, SIGNAL(triggered()), this, SLOT(InsertFromAction()));
  latex16Menu->addAction(Act);
  Act = new QAction("\\medskip", this);
  Act->setData(
      "\\medskip /9/0/The \\medskip command adds a 'medium' vertical space.");
  connect(Act, SIGNAL(triggered()), this, SLOT(InsertFromAction()));
  latex16Menu->addAction(Act);
  ...
  Act = new QAction("\\cite{}", this);
  Act->setData(
      "\\cite{} /6/0/\\cite{ref} :\nThis command generates an in-text citation "
      "to the reference associated with the ref entry in the bib file");
  connect(Act, SIGNAL(triggered()), this, SLOT(InsertFromAction()));
  latex1Menu->addAction(Act);
  Act = new QAction("\\footnote{}", this);
  Act->setData(
      "\\footnote{} /10/0/\\footnote[number]{text}\nThe \\footnote command "
      "places the numbered footnote text at the bottom of the current page.");
  connect(Act, SIGNAL(triggered()), this, SLOT(InsertFromAction()));
  latex1Menu->addAction(Act);
  Act = new QAction("\\bibliographystyle{}", this);
  Act->setData(
      "\\bibliographystyle{} /19/0/The argument to \\bibliographystyle refers "
      "to a file style.bst, which defines how your citations will look");
  connect(Act, SIGNAL(triggered()), this, SLOT(InsertFromAction()));
  latex1Menu->addAction(Act);
  ...
  Act->setData(
      "\\[" + QString(0x2022) +
      "\\]/3/0/The displaymath environment can be used only in paragraph mode");
  connect(Act, SIGNAL(triggered()), this, SLOT(InsertFromAction()));
  math1Menu->addAction(Act);
  Act = new QAction(tr("Numbered equations \\begin{equation}"), this);
  Act->setShortcut(Qt::CTRL + Qt::SHIFT + Qt::Key_N);
  Act->setData("\\begin{equation}\n\n\\end{equation}/0/1/The equation "
               "environment centres your equation on the page and places the "
  ...
  Act->setData(
      ...
      "display a sequence of equations or inequalities.");
  connect(Act, SIGNAL(triggered()), this, SLOT(InsertFromAction()));
  math1Menu->addAction(Act);
  Act = new QAction("\\begin{align} (AMS)", this);
  Act->setData("\\begin{align}\n\n\\end{align}/0/1/\\begin{align}\nmath "
               "formula 1 \\\\\n\\end{align}\nThe AMS align environment is "
               "used to display a sequence of equations or inequalities.");
  connect(Act, SIGNAL(triggered()), this, SLOT(InsertFromAction()));
  math1Menu->addAction(Act);
  ...
  connect(ViewStructurePanelAct, SIGNAL(triggered()), this,
          SLOT(ToggleStructurePanel()));
  ...
  // connect(ViewPdfPanelAct, SIGNAL(triggered()), this,
  // SLOT(TogglePdfPanel())); if (embedinternalpdf)
  //   {
  ...
  // connect(ViewSourcePanelAct, SIGNAL(triggered()), this,
  // SLOT(ToggleSourcePanel())); viewMenu->addAction(ViewSourcePanelAct);
  ...
  connect(ViewOpenedFilesPanelAct, SIGNAL(triggered()), this,
          SLOT(ToggleFilesPanel()));
  ...
  ToggleAct =
      new QAction(tr("Define Current Document as 'Master Document'"), this);
...
// appearanceMenu->addAction(Act);
  ...
  for (int i = 0; i < translationList.count(); i++) {
    ...
    if ((currentTranslation == translationList.at(i)) ||
        (currentTranslation.left(2) == translationList.at(i))) {
      Act->setChecked(true);
    }
  ...
  if (shortcuts.isEmpty()) {
    ...
    while (iterator.hasNext()) {
      ...
      if (action && (!action->menu()) &&
        ...
        if (action->shortcut().isEmpty())
          shortcuts.insert(action->data().toString(), "none");
        else
          shortcuts.insert(
    ...
    if (!hasNextPrev) {
      shortcuts.insert(
          NextDocAct->data().toString(),
          NextDocAct->shortcut().toString(QKeySequence::PortableText));
      actionstext.insert(NextDocAct->data().toString(), NextDocAct->text());
      shortcuts.insert(
          PrevDocAct->data().toString(),
          PrevDocAct->shortcut().toString(QKeySequence::PortableText));
      actionstext.insert(PrevDocAct->data().toString(), PrevDocAct->text());
    }
    if (!hasQuote) {
      shortcuts.insert(latex18Menu->actions().at(0)->data().toString(),
                       latex18Menu->actions().at(0)->shortcut().toString(
                           QKeySequence::PortableText));
      actionstext.insert(latex18Menu->actions().at(0)->data().toString(),
                         latex18Menu->actions().at(0)->text());
      shortcuts.insert(latex18Menu->actions().at(1)->data().toString(),
                       latex18Menu->actions().at(1)->shortcut().toString(
                           QKeySequence::PortableText));
      actionstext.insert(latex18Menu->actions().at(1)->data().toString(),
                         latex18Menu->actions().at(1)->text());
    }
    if (!hasTools) {
      listaction << toolMenu->actions();
      QListIterator<QAction *> iterator(listaction);
...
void Texmaker::UpdateCaption() {
  ...
  int check = comboFiles->findData(finame, Qt::UserRole,
  ...
  if (currentEditorView()) {
    ...
    UndoAct->setEnabled(
        currentEditorView()->editor->document()->isUndoAvailable());
    RedoAct->setEnabled(
        currentEditorView()->editor->document()->isRedoAvailable());
    CopyAct->setEnabled(
        currentEditorView()->editor->textCursor().hasSelection());
    CutAct->setEnabled(
        currentEditorView()->editor->textCursor().hasSelection());
    stat3->setText(
        QString(" %1 ").arg(currentEditorView()->editor->getEncoding()));
  } else {
  ...
  if (currentEditorView()) {
    ...
    showCursorPos(
        currentEditorView()->editor->textCursor().blockNumber() + 1,
        currentEditorView()->editor->textCursor().position() -
            currentEditorView()->editor->textCursor().block().position() + 1);
    //  showCursorPos(currentEditorView()->editor->textCursor().blockNumber() +
    //  1,currentEditorView()->editor->textCursor().position() -
    //  currentEditorView()->editor->document()->findBlock(currentEditorView()->editor->textCursor().selectionStart()).position());
  } else
...
void Texmaker::NewDocumentStatus(bool m) {
  ...
  if (m) {
    ...
    // EditorView->setTabText(EditorView->indexOf(currentEditorView()),QFileInfo(
    // getName() ).fileName());
    comboFiles->setItemIcon(
        comboFiles->findData(finame, Qt::UserRole,
                             Qt::MatchExactly | Qt::MatchCaseSensitive),
        getIcon(":/images/modified.png"));
    if ((check > -1) && (check < OpenedFilesListWidget->count()))
      OpenedFilesListWidget->item(check)->setIcon(
          getIcon(":/images/modified.png"));
...
LatexEditorView *Texmaker::currentEditorView() const {
  if (EditorView->currentWidget() &&
      EditorView->currentWidget()->inherits("LatexEditorView"))
    return (LatexEditorView *)EditorView->currentWidget();
  return 0;
}
...
void Texmaker::ComboFilesInsert(const QString &file) {
  ...
  for (index = 0; index < comboFiles->count(); index++)
    if (comboFiles->itemText(index).localeAwareCompare(fname) > 0)
      break;
...
void Texmaker::load(const QString &f) {
  if (FileAlreadyOpen(f) || !QFile::exists(f))
    return;
  QFileInfo fi(f);
  if (fi.suffix() == "tks") {
    LoadSessionFile(f);
  ...
  if (bytesRead >= 4 && ((uchar(buf[0]) == 0xff && uchar(buf[1]) == 0xfe &&
                         ...
                         (uchar(buf[0]) == 0 && uchar(buf[1]) == 0 &&
                          uchar(buf[2]) == 0xfe && uchar(buf[3]) == 0xff))) {
    detected_codec = QTextCodec::codecForName("UTF-32");
    if (detected_codec)
      new_encoding = detected_codec->name();
  } else if (bytesRead >= 2 &&
             ((uchar(buf[0]) == 0xff && uchar(buf[1]) == 0xfe) ||
              (uchar(buf[0]) == 0xfe && uchar(buf[1]) == 0xff))) {
    detected_codec = QTextCodec::codecForName("UTF-16");
    if (detected_codec)
      new_encoding = detected_codec->name();

  } else if (bytesRead >= 3 && uchar(buf[0]) == 0xef && uchar(buf[1]) == 0xbb &&
             uchar(buf[2]) == 0xbf) {
  ...
  if (pos > -1) {
    ...
    if (fidic.exists() && fidic.isReadable() && fiaff.exists() &&
        fiaff.isReadable()) {
      spellChecker =
          new Hunspell(lang.toLatin1() + ".aff", lang.toLatin1() + ".dic");
    } else
      spellChecker = 0;
  }

  LatexEditorView *edit = new LatexEditorView(
      0, EditorFont, svnEnable, showline, edcolors(), hicolors(),
      inlinespellcheck, spell_ignored_words, spellChecker, tabspaces, tabwidth,
      QKeySequence(keyToggleFocus), f, userTagsList);
  EditorView->addWidget(edit);
  ComboFilesInsert(f);
  disconnect(EditorView, SIGNAL(currentChanged(int)), this,
             SLOT(UpdateStructure()));
  ...
  if (hasDecodingError)
    edit->editor->setEncoding(new_encoding);
  else
    edit->editor->setEncoding(input_encoding);
  initCompleter();
  if (completion)
    edit->editor->setCompleter(completer);
  else
    edit->editor->setCompleter(0);
  ...
  connect(edit->editor->document(), SIGNAL(modificationChanged(bool)), this,
          SLOT(NewDocumentStatus(bool)));
  connect(edit->editor, SIGNAL(spellme()), this, SLOT(editSpell()));
  connect(edit->editor, SIGNAL(tooltiptab()), this, SLOT(editTipTab()));
  connect(edit->editor, SIGNAL(requestpdf(int)), this,
          SLOT(jumpToPdfline(int)));
  connect(edit->editor, SIGNAL(requestUpdateStructure()), this,
          SLOT(UpdateStructure()));
  currentEditorView()->editor->setLastNumLines(
      currentEditorView()->editor->numoflines());
  connect(edit->editor, SIGNAL(numLinesChanged(int)), this,
          SLOT(refreshAllFromCursor(int)));
  connect(edit->editor->document(), SIGNAL(undoAvailable(bool)), UndoAct,
          SLOT(setEnabled(bool)));
  connect(edit->editor->document(), SIGNAL(redoAvailable(bool)), RedoAct,
          SLOT(setEnabled(bool)));
  connect(edit->editor, SIGNAL(copyAvailable(bool)), CutAct,
          SLOT(setEnabled(bool)));
  connect(edit->editor, SIGNAL(copyAvailable(bool)), CopyAct,
          SLOT(setEnabled(bool)));
  connect(edit->editor, SIGNAL(requestGotoStructure(int)), this,
          SLOT(jumpToStructure(int)));
  connect(edit->editor, SIGNAL(poshaschanged(int, int)), this,
          SLOT(showCursorPos(int, int)));
...
void Texmaker::fileNew() {
  LatexEditorView *edit = new LatexEditorView(
      0, EditorFont, svnEnable, showline, edcolors(), hicolors(),
      inlinespellcheck, spell_ignored_words, spellChecker, tabspaces, tabwidth,
      QKeySequence(keyToggleFocus), "untitled" + QString::number(untitled_id),
      userTagsList);
  edit->editor->setReadOnly(false);
  edit->editor->setEncoding(input_encoding);
  initCompleter();
...
void Texmaker::fileNewFromFile() {
  ...
  LatexEditorView *edit = new LatexEditorView(
      0, EditorFont, svnEnable, showline, edcolors(), hicolors(),
      inlinespellcheck, spell_ignored_words, spellChecker, tabspaces, tabwidth,
      QKeySequence(keyToggleFocus), fn, userTagsList);
  edit->editor->setReadOnly(false);
  edit->editor->setEncoding(input_encoding);
  initCompleter();
  if (completion)
    ...
    if (!getName().startsWith("untitled")) {
      ...
      if (isCurrentModifiedOutside()) {
        ...
        choice = QMessageBox::warning(
            ...
            tr("Reload the file"), tr("Save"), tr("Cancel"), 0, 2);
        if (choice == 0) {
          if (fi.exists() && fi.isReadable()) {
            QFile file(fn);
            if (file.open(QIODevice::ReadOnly)) {
              ...
              disconnect(currentEditorView()->editor->document(),
                         SIGNAL(modificationChanged(bool)), this,
                         SLOT(NewDocumentStatus(bool)));
              disconnect(currentEditorView()->editor, SIGNAL(spellme()), this,
                         SLOT(editSpell()));
              disconnect(currentEditorView()->editor, SIGNAL(tooltiptab()),
                         this, SLOT(editTipTab()));
              disconnect(currentEditorView()->editor,
                         SIGNAL(requestUpdateStructure()), this,
                         SLOT(UpdateStructure()));
              disconnect(currentEditorView()->editor, SIGNAL(requestpdf(int)),
                         this, SLOT(jumpToPdfline(int)));
              disconnect(currentEditorView()->editor->document(),
                         SIGNAL(undoAvailable(bool)), UndoAct,
                         SLOT(setEnabled(bool)));
              disconnect(currentEditorView()->editor->document(),
                         SIGNAL(redoAvailable(bool)), RedoAct,
                         SLOT(setEnabled(bool)));
              disconnect(currentEditorView()->editor,
                         SIGNAL(copyAvailable(bool)), CutAct,
                         SLOT(setEnabled(bool)));
              disconnect(currentEditorView()->editor,
                         SIGNAL(copyAvailable(bool)), CopyAct,
                         SLOT(setEnabled(bool)));
              disconnect(currentEditorView()->editor,
                         SIGNAL(numLinesChanged(int)), this,
                         SLOT(refreshAllFromCursor(int)));
              disconnect(currentEditorView()->editor,
                         SIGNAL(requestGotoStructure(int)), this,
                         SLOT(jumpToStructure(int)));
              disconnect(currentEditorView()->editor,
                         SIGNAL(poshaschanged(int, int)), this,
                         SLOT(showCursorPos(int, int)));
              currentEditorView()->editor->setPlainText(ts.readAll());
              file.close();
              currentEditorView()->editor->setLastSavedTime(
                  QDateTime::currentDateTime());
              connect(currentEditorView()->editor->document(),
                      SIGNAL(modificationChanged(bool)), this,
                      SLOT(NewDocumentStatus(bool)));
              connect(currentEditorView()->editor, SIGNAL(spellme()), this,
                      SLOT(editSpell()));
              connect(currentEditorView()->editor, SIGNAL(tooltiptab()), this,
                      SLOT(editTipTab()));
              connect(currentEditorView()->editor,
                      SIGNAL(requestUpdateStructure()), this,
                      SLOT(UpdateStructure()));
              connect(currentEditorView()->editor, SIGNAL(requestpdf(int)),
                      this, SLOT(jumpToPdfline(int)));
              connect(currentEditorView()->editor->document(),
                      SIGNAL(undoAvailable(bool)), UndoAct,
                      SLOT(setEnabled(bool)));
              connect(currentEditorView()->editor->document(),
                      SIGNAL(redoAvailable(bool)), RedoAct,
                      SLOT(setEnabled(bool)));
              connect(currentEditorView()->editor, SIGNAL(copyAvailable(bool)),
                      CutAct, SLOT(setEnabled(bool)));
              connect(currentEditorView()->editor, SIGNAL(copyAvailable(bool)),
                      CopyAct, SLOT(setEnabled(bool)));
              currentEditorView()->editor->setLastNumLines(
                  currentEditorView()->editor->numoflines());
              connect(currentEditorView()->editor, SIGNAL(numLinesChanged(int)),
                      this, SLOT(refreshAllFromCursor(int)));
              connect(currentEditorView()->editor,
                      SIGNAL(requestGotoStructure(int)), this,
                      SLOT(jumpToStructure(int)));
              connect(currentEditorView()->editor,
    ...
    if (locale == "en") {
      ...
      query = QMessageBox::warning(
          ...
          tr("The document contains unsaved work. "
             "Do you want to save it before closing?"),
          tr("Save and Close"), tr("Don't Save and Close"), tr("Cancel"), 0, 2);
    }
    switch (query) {
    case 0:
      fileSave();
    ...
    if (currentEditorView()->editor->document()->isModified()) {
      if (locale == "en") {
        ...
        query = QMessageBox::warning(
            ...
            tr("The document contains unsaved work. "
               "Do you want to save it before closing?"),
            tr("Save and Close"), tr("Don't Save and Close"), tr("Cancel"), 0,
            2);
      }
      switch (query) {
      case 0:
...
void Texmaker::UpdateRecentFile() {
  ...
  for (int j = recentFilesList.count(); j < 10; ++j)
...
void Texmaker::listSelectionActivated(int index) {
  disconnect(OpenedFilesListWidget, SIGNAL(itemClicked(QListWidgetItem *)),
             this, SLOT(OpenedFileActivated(QListWidgetItem *)));
  if ((index > -1) && (index < OpenedFilesListWidget->count()))
    OpenedFilesListWidget->setCurrentRow(index);
  connect(OpenedFilesListWidget, SIGNAL(itemClicked(QListWidgetItem *)), this,
          SLOT(OpenedFileActivated(QListWidgetItem *)));
...
void Texmaker::foldEnclosing() {
  ...
  while (it.hasNext()) {
    ...
    int startLine = it.key();
    int endLine = it.value();
    if (startLine <= line && endLine >= line && foldedStartLine >= startLine &&
  ...
  while (it2.hasNext()) {
    ...
    if (startLine <= line && endLine > line && bestStartLine <= startLine &&
        bestEndLine >= endLine && foldedStartLine > startLine &&
        foldedEndLine <= endLine) {
...
void Texmaker::ReadSettings() {
  ...
  int w =
      config->value("Geometries/MainwindowWidth", screen.width() - 150).toInt();
  int h = config->value("Geometries/MainwindowHeight", screen.height() - 100)
              .toInt();
  ...
  while (dataiterator.hasNext() && shortcutiterator.hasNext()) {
    ...
    if (!d.isEmpty())
      shortcuts.insert(d, shortcutiterator.next());
  }
  ...
  if (xf.contains("DejaVu Sans", Qt::CaseInsensitive))
    deft = "DejaVu Sans";
  else if (xf.contains("DejaVu Sans LGC", Qt::CaseInsensitive))
    deft = "DejaVu Sans LGC";
  else if (xf.contains("Bitstream Vera Sans", Qt::CaseInsensitive))
    deft = "Bitstream Vera Sans";
  else if (xf.contains("Luxi Sans", Qt::CaseInsensitive))
    deft = "Luxi Sans";
  else
    deft = qApp->font().family();
  ...
  struct_level1 =
      config->value("Structure/Structure Level 1", "part").toString();
  struct_level2 =
      config->value("Structure/Structure Level 2", "chapter").toString();
  struct_level3 =
      config->value("Structure/Structure Level 3", "section").toString();
  struct_level4 =
      config->value("Structure/Structure Level 4", "subsection").toString();
  struct_level5 =
      config->value("Structure/Structure Level 5", "subsubsection").toString();
  ...
  if (locale == "en")
    babel_default = config->value("Quick/BabelDefault", "english").toString();
  else if (locale == "de")
    babel_default = config->value("Quick/BabelDefault", "german").toString();
  else if (locale == "fr")
    babel_default = config->value("Quick/BabelDefault", "french").toString();
  else if (locale == "ru")
    babel_default = config->value("Quick/BabelDefault", "russian").toString();
  else if (locale == "it")
    babel_default = config->value("Quick/BabelDefault", "italian").toString();
  else if (locale == "es")
    babel_default = config->value("Quick/BabelDefault", "spanish").toString();
  else if (locale == "pl")
    babel_default = config->value("Quick/BabelDefault", "polish").toString();
  else if (locale == "fa")
    babel_default = config->value("Quick/BabelDefault", "farsi").toString();
  else if (locale == "cz")
    babel_default = config->value("Quick/BabelDefault", "czech").toString();
  else if (locale == "pt")
    babel_default =
        config->value("Quick/BabelDefault", "portuguese").toString();
  else if (locale == "sl")
    babel_default = config->value("Quick/BabelDefault", "slovak").toString();
  else if (locale == "gr")
    babel_default = config->value("Quick/BabelDefault", "greek").toString();
  else if (locale == "fi")
    babel_default = config->value("Quick/BabelDefault", "finish").toString();
  else if (locale == "hu")
    babel_default = config->value("Quick/BabelDefault", "magyar").toString();
  else
    babel_default = config->value("Quick/BabelDefault", "").toString();
  ...
  geometry_options = config
                         ->value("Quick/GeometryOptions",
  ...
  if (locale == "en")
    beamer_babel = config->value("Beamer/BabelDefault", "english").toString();
  else if (locale == "de")
    beamer_babel = config->value("Beamer/BabelDefault", "german").toString();
  else if (locale == "fr")
    beamer_babel = config->value("Beamer/BabelDefault", "french").toString();
  else if (locale == "ru")
    beamer_babel = config->value("Beamer/BabelDefault", "russian").toString();
  else if (locale == "it")
    beamer_babel = config->value("Beamer/BabelDefault", "italian").toString();
  else if (locale == "es")
    beamer_babel = config->value("Beamer/BabelDefault", "spanish").toString();
  else if (locale == "pl")
    beamer_babel = config->value("Beamer/BabelDefault", "polish").toString();
  else if (locale == "fa")
    beamer_babel = config->value("Beamer/BabelDefault", "farsi").toString();
  else if (locale == "cz")
    beamer_babel = config->value("Beamer/BabelDefault", "czech").toString();
  else if (locale == "pt")
    beamer_babel =
        config->value("Beamer/BabelDefault", "portuguese").toString();
  else if (locale == "sl")
    beamer_babel = config->value("Beamer/BabelDefault", "slovak").toString();
  else if (locale == "gr")
    beamer_babel = config->value("Beamer/BabelDefault", "greek").toString();
  else if (locale == "fi")
    beamer_babel = config->value("Beamer/BabelDefault", "finish").toString();
  else if (locale == "hu")
    beamer_babel = config->value("Beamer/BabelDefault", "magyar").toString();
  else
  ...
  for (int i = 0; i < 412; i++) {
    symbolScore[i] =
        config->value("Symbols/symbol" + QString::number(i), 0).toInt();
  }
  favoriteSymbolList.clear();
  QList<QVariant> favoriteSymbolSettings =
      config->value("Symbols/Favorites").toList();
  if (!favoriteSymbolSettings.isEmpty()) {
    for (int i = 0; i < favoriteSymbolSettings.count(); i++)
      favoriteSymbolList.append(favoriteSymbolSettings.at(i).toInt());
  }

  colorBackground =
      config->value("Color/Background", QColor("#FFFFFF")).value<QColor>();
  colorLine = config->value("Color/Line", QColor("#ececec")).value<QColor>();
  colorHighlight =
      config->value("Color/Highlight", QColor("#FF0000")).value<QColor>();
  colorStandard =
      config->value("Color/Standard", QColor("#000000")).value<QColor>();
  colorComment =
      config->value("Color/Comment", QColor("#606060")).value<QColor>();
  colorMath = config->value("Color/Math", QColor("#008000")).value<QColor>();
  colorCommand =
      config->value("Color/Command", QColor("#800000")).value<QColor>();
  colorKeyword =
      config->value("Color/Keyword", QColor("#0000CC")).value<QColor>();
  colorVerbatim =
      config->value("Color/Verbatim", QColor("#9A4D00")).value<QColor>();
  colorTodo = config->value("Color/Todo", QColor("#FF0000")).value<QColor>();
  colorKeywordGraphic =
      config->value("Color/KeywordGraphic", QColor("#006699")).value<QColor>();
  colorNumberGraphic =
      config->value("Color/NumberGraphic", QColor("#660066")).value<QColor>();
...
void Texmaker::SaveSettings() {
  ...
  if (userPaperList.count() > 0)
    config.setValue("Tools/User Paper", userPaperList);
  if (userEncodingList.count() > 0)
    config.setValue("Tools/User Encoding", userEncodingList);
  if (userOptionsList.count() > 0)
  ...
  /*if (recentFilesList.count()>0)*/ config.setValue("Files/Recent Files New",
                                                     recentFilesList);
  ...
  if (!favoriteSymbolList.isEmpty()) {
    for (int i = 0; i < favoriteSymbolList.count(); i++)
      favoriteSymbolSettings.append(favoriteSymbolList.at(i));
  }
...
void Texmaker::OpenedFileActivated(QListWidgetItem *item) {
  ...
  disconnect(comboFiles, SIGNAL(activated(int)), this,
             SLOT(listSelectionActivated(int)));
  if ((index > -1) && (index < comboFiles->count()))
    comboFiles->setCurrentIndex(index);
  connect(comboFiles, SIGNAL(activated(int)), this,
          SLOT(listSelectionActivated(int)));
  QString f = comboFiles->itemData(index, Qt::UserRole).toString();
  FilesMap::Iterator it;
...
void Texmaker::UpdateStructure() {
  ...
  QString current;
  if (StructureTreeWidget->currentItem())
    current = StructureTreeWidget->currentItem()->text(0);
  ...
  if ((shortName.right(4) != ".tex") && (shortName.right(4) != ".Rnw") &&
      (!shortName.startsWith("untitled")))
    return;
  /*************************************/
  QList<QTreeWidgetItem *> fItems;
  bool islabels_expanded = false;
  ...
  top->setFont(0, deft);
  Child = parent_level[0] = parent_level[1] = parent_level[2] =
      parent_level[3] = parent_level[4] = top;
  labelitem.clear();
  if (singlemode) {
    listbibfiles.clear();
  ...
  const QList<StructItem> &structure =
      currentEditorView()->editor->getStructItems();
  // int i;
  for (int j = 0; j < structure.count(); j++) {
    ...
    case 4: {
      ...
      parent_level[1] = parent_level[2] = parent_level[3] = parent_level[4] =
          parent_level[0];
    } break;
    case 5: {
      s = structure.at(j).item;
  ...
  if (!current.isEmpty()) {
    QList<QTreeWidgetItem *> fItems =
        StructureTreeWidget->findItems(current, Qt::MatchRecursive, 0);
  ...
  int endpreamble =
      currentEditorView()->editor->searchLine("\\begin{document}");
  if (endpreamble > 1)
    currentEditorView()->editor->foldableLines.insert(0, endpreamble - 1);
  ParseTree(top);
  UpdateChildsLabels(listchildfiles);
  updateCompleter();
  if (currentEditorView()) {
    if (completion)
      currentEditorView()->editor->setCompleter(completer);
    else
...
void Texmaker::UpdateChildsLabels(QStringList listfiles) {
  if (!currentEditorView())
    return;
  QString shortName = getName();
  if ((shortName.right(4) != ".tex") && (!shortName.startsWith("untitled")))
    return;
  // currentEditorView()->editor->highlighter->rehighlight();
  int pos;
  while ((pos = (int)shortName.indexOf('/')) != -1)
...
void Texmaker::UpdateBibliography() {
  ...
  if (listbibfiles.count() > 0) {
    ...
    types << QLatin1String("article") << QLatin1String("book")
          ...
          << QLatin1String("patent");
    QRegExp macroName("@(" + types.join("|") + ")\\s*\\{\\s*(.*),",
                      Qt::CaseInsensitive);
    macroName.setMinimal(true);
    QString line;
      ...
      if (fi.exists() && fi.isReadable()) {
        ...
        if (f.open(QIODevice::ReadOnly)) {
          ...
          while (!t.atEnd()) {
            ...
            if (!line.isEmpty()) {
              if (macroName.indexIn(line) > -1)
                bibitem.append(macroName.cap(2).trimmed());
            }
          }
        }
        f.close();
...
int Texmaker::LevelItem(const QTreeWidgetItem *item) {
  ...
  if ((item) && (structure.count() > 0)) {
    ...
    if (index < structure.count()) {
      if ((structure.at(index).type <= 3) || (structure.at(index).type == 9))
        level = 0;
      else
        level = structure.at(index).type - 3;
    }
  }
  return level;
...
int Texmaker::LineItem(const QTreeWidgetItem *item) {
  ...
  if ((item) && (structure.count() > 0)) {
    int index = item->text(1).toInt();
    if (index < structure.count()) {
      line = structure.at(index)
                 .cursor.block()
                 .blockNumber(); // line=structure.at(index).line;
    }
  }
  return line;
  ...
  if (level >= 1) {
    ...
    do {
      ...
      if (parentitem) {
        ...
        index = -1;
    } while ((index >= 0) && (index >= parentitem->childCount() - 1) &&
             (LevelItem(parentitem) >= 1));
    if (index >= 0 && index < parentitem->childCount() - 1)
      end = LineItem(parentitem->child(index + 1));
    else {
      end = currentEditorView()->editor->searchLine("\\end{document}");
      if (end < 0)
        end = currentEditorView()->editor->numoflines();
    }
    if (start < end - 1) {
    ...
    if (index < structure.count()) {
      ...
      if (hasname && (type == 2) || (type == 3)) {
        ...
        currentEditorView()->editor->gotoLine(
            structure.at(index).cursor.block().blockNumber());
        if (!hasname)
          return;
...
void Texmaker::InsertTag(QString Entity, int dx, int dy) {
  ...
  if (Entity.contains(QString(0x2022))) {
    currentEditorView()->editor->setTextCursor(cur);
    currentEditorView()->editor->search(QString(0x2022), true, false, true,
                                        true, false);
    OutputTextEdit->insertLine("Use the Tab key to reach the next " +
                               QString(0x2022) + " field");
  } else {
...
void Texmaker::InsertSymbol(QTableWidgetItem *item) {
  ...
  int dx;
  if (item) {
    if (rxnumber.indexIn(item->text()) != -1)
      number = rxnumber.cap(1).toInt();
    if ((number > -1) && (number < 412))
      symbolScore[number] = symbolScore[number] + 1;
    code_symbol = item->text().remove(rxnumber);
    dx = code_symbol.indexOf("{}", 0);
    if (dx > -1)
      InsertTag(code_symbol, dx + 1, 0);
    else
  ...
  if (item && !item->font().bold()) {
    ...
    if ((dx == 0) && (dy == 0)) {
      if (!currentEditorView()->editor->textCursor().hasSelection())
        ...
        dx = code.length() -
             currentEditorView()->editor->textCursor().selectedText().length();
    }
...
void Texmaker::InsertFromAction() {
  ...
  if (action) {
    ...
    InsertTag(tagList.at(0), tagList.at(1).toInt(&ok, 10),
              tagList.at(2).toInt(&ok, 10));
  ...
  if (action) {
    ...
    if (!currentEditorView()->editor->textCursor().hasSelection()) {
      OutputTextEdit->insertLine(
          "You can select a text before using this environment.");
      InsertTag(tagList.at(0) + tagList.at(1), tagList.at(2).toInt(&ok, 10),
                tagList.at(3).toInt(&ok, 10));
    } else {
      currentEditorView()->editor->cut();
      InsertTag(tagList.at(0) + tagList.at(1), tagList.at(2).toInt(&ok, 10),
                tagList.at(3).toInt(&ok, 10));
...
void Texmaker::InsertWithSelectionFromString(const QString &text) {
  ...
  tagList = text.split("/");
  if (!currentEditorView()->editor->textCursor().hasSelection()) {
    InsertTag(tagList.at(0) + QString(0x2022) + tagList.at(1),
              tagList.at(2).toInt(&ok, 10), tagList.at(3).toInt(&ok, 10));
  } else {
    currentEditorView()->editor->cut();
    InsertTag(tagList.at(0) + QString(0x2022) + tagList.at(1),
              tagList.at(2).toInt(&ok, 10), tagList.at(3).toInt(&ok, 10));
...
void Texmaker::InsertBib() {
  ...
  OutputTextEdit->setMaximumHeight(splitter2->sizes().at(1));
  separatorline->hide();
  OutputTextEdit->insertLine("The argument to \\bibliography refers to the bib "
...
void Texmaker::InsertImage() {
  ...
  if (sfDlg->exec()) {
    ...
    if (!sfDlg->ui.moreButton->isChecked())
      ...
      if (sfDlg->ui.checkBoxCentering->isChecked())
        tag += "\\centering\n";
      tag += "\\includegraphics[scale=1]{" + fi.filePath() + "}\n";
      if (sfDlg->ui.comboBoxCaption->currentIndex() == 1)
        tag += "\\caption{" + sfDlg->ui.lineEditCaption->text() + "}\n";
      tag += "\\end{figure}\n";
      InsertTag(tag, 0, 4);
    }
...
void Texmaker::QuickTabular() {
  ...
  alignlist << QString("c") << QString("l") << QString("r") << QString("p{}")
            << QString(">{\\centering\\arraybackslash}p{}")
            << QString(">{\\raggedleft\\arraybackslash}p{}");
  QString al = "";
  QString vs = "";
  QString el = "";
  QString tag;
  ...
  if (quickDlg->exec()) {
    ...
    tag += QString("}\n");
    for (int i = 0; i < y; i++) {
      if (quickDlg->liDataList.at(i).topborder)
        tag += QString("\\hline \n");
      if (quickDlg->ui.checkBoxMargin->isChecked())
        tag += "\\rule[-1ex]{0pt}{2.5ex} ";
      if (quickDlg->liDataList.at(i).merge &&
          (quickDlg->liDataList.at(i).mergeto >
           quickDlg->liDataList.at(i).mergefrom)) {
        el = "";
        for (int j = 0; j < x; j++) {
          ...
          if (j == quickDlg->liDataList.at(i).mergefrom - 1) {
            ...
            tag += QString::number(quickDlg->liDataList.at(i).mergeto -
                                   quickDlg->liDataList.at(i).mergefrom + 1);
            tag += QString("}{");
            if ((j == 0) && (quickDlg->colDataList.at(j).leftborder < 2))
              tag += borderlist.at(quickDlg->colDataList.at(j).leftborder);
            if (quickDlg->colDataList.at(j).alignment < 3)
              tag += alignlist.at(quickDlg->colDataList.at(j).alignment);
            else
              tag += QString("c");
            if (quickDlg->liDataList.at(i).mergeto == x)
              tag +=
                  borderlist.at(quickDlg->ui.comboBoxEndBorder->currentIndex());
            else
              tag += borderlist.at(
                  quickDlg->colDataList.at(quickDlg->liDataList.at(i).mergeto)
                      .leftborder);
            tag += QString("}{");
            ...
            if (j < x - 1)
              ...
              tag += QString(" \\\\ \n");
          } else if ((j > quickDlg->liDataList.at(i).mergefrom - 1) &&
                     (j < quickDlg->liDataList.at(i).mergeto - 1)) {
            if (item)
              el += item->text();
          } else {
            if (item) {
    ...
    if (quickDlg->ui.checkBoxBorderBottom->isChecked())
      tag += QString("\\hline \n\\end{tabular} ");
    else
      tag += QString("\\end{tabular} ");
...
void Texmaker::QuickLetter() {
  ...
  if (ltDlg->exec()) {
    ...
    tag += QString("\n");
    if (ltDlg->ui.comboBoxEncoding->currentText() != "NONE")
      tag += QString("\\usepackage[") +
             ltDlg->ui.comboBoxEncoding->currentText() + QString("]{inputenc}");
    if (ltDlg->ui.comboBoxEncoding->currentText().startsWith("utf8x"))
...
void Texmaker::QuickBeamer() {
  ...
  f = beamDlg->ui.comboBoxTheme->findText(
      beamer_theme, Qt::MatchExactly | Qt::MatchCaseSensitive);
  beamDlg->ui.comboBoxTheme->setCurrentIndex(f);
  f = beamDlg->ui.comboBoxSize->findText(
      beamer_size, Qt::MatchExactly | Qt::MatchCaseSensitive);
  beamDlg->ui.comboBoxSize->setCurrentIndex(f);
  f = beamDlg->ui.comboBoxEncoding->findText(
      beamer_encoding, Qt::MatchExactly | Qt::MatchCaseSensitive);
  beamDlg->ui.comboBoxEncoding->setCurrentIndex(f);
  QList<QListWidgetItem *> babItems = beamDlg->ui.listWidgetBabel->findItems(
      beamer_babel, Qt::MatchExactly | Qt::MatchCaseSensitive);
  if (babItems.size() > 0)
    beamDlg->ui.listWidgetBabel->setCurrentItem(babItems.at(0));
  ...
  if (beamDlg->exec()) {
    ...
    tag += QString("\\begin{document}\n\n");
    if ((beamDlg->ui.lineEditAuthor->text() != "") ||
        (beamDlg->ui.lineEditTitle->text() != ""))
      tag += QString("\\begin{frame}\n\\titlepage\n\\end{frame}\n\n");
    else
      tag += QString("%\\begin{frame}\n%\\titlepage\n%\\end{frame}\n\n");
    tag += QString("%\\begin{frame}\n%\\tableofcontents\n%\\end{frame}\n\n");
    tag +=
        QString("\\begin{frame}{" + QString(0x2022) + "}\n\n\\end{frame}\n\n");
...
void Texmaker::InsertBibLatex5() {
  ...
  InsertTag(tag, 9, 0);
  OutputTextEdit->insertLine(
      "Bib fields - A book-like work without a formal publisher");
  OutputTextEdit->insertLine(
      "OPT.... : optional fields (use the 'Clean' command to remove them)");
}
...
void Texmaker::InsertBibLatex13() {
  ...
  InsertTag(tag, 12, 0);
  OutputTextEdit->insertLine(
      "Bib fields - Single-volume conference proceedings");
  OutputTextEdit->insertLine(
      "OPT.... : optional fields (use the 'Clean' command to remove them)");
}
...
void Texmaker::InsertBibLatex14() {
  ...
  InsertTag(tag, 14, 0);
  OutputTextEdit->insertLine(
      "Bib fields - Multi-volume conference proceedings");
  OutputTextEdit->insertLine(
      "OPT.... : optional fields (use the 'Clean' command to remove them)");
}
...
void Texmaker::InsertUserTag(QString Entity) {
  ...
  while ((index = rx.indexIn(Entity, index)) != -1) {
    if (rx.cap(1) == "@")
      Entity.replace(rx.pos(1), 1, QString(0x2022));
    else if (rx.cap(1) == "@@")
      Entity.replace(rx.pos(1), 2, "@");
...
void Texmaker::SizeCommand() {
  ...
  if (text == "tiny") {
    if (currentEditorView()->editor->textCursor().hasSelection() &&
        !currentEditorView()->editor->textCursor().selectedText().contains(
            QString(0x2029))) {
...
void Texmaker::ClickedOnLogLine(QTableWidgetItem *item) {
  ...
  if (col != 3)
    content = OutputTableWidget->item(row, 3)->text();
  ...
  if (ok) {
    if (file.isEmpty())
      ...
      QFileInfo fi(file);
      if (fi.exists() && fi.isReadable())
        fileOpenAndGoto(fi.absoluteFilePath(), l + 1, true);
      else {
        QFileInfo fic(getName());
        file = fic.absolutePath() + "/" + file;
        QFileInfo ffi(file);
        if (ffi.exists() && ffi.isReadable())
  ...
  while (tb.isValid()) {
    ...
    while (j < expression.length()) {
      ...
      if (lettre == "(" || lettre == ")") {
        ...
        mot = "";
        while (j < expression.length() &&
               (expression.mid(j, 1) != "(" && expression.mid(j, 1) != ")")) {
    ...
    //	else if (expression.contains(QRegExp("^!")))
      ...
      // 			errorMessageList.append(rxLatexError.cap(3)+"
      // :"+rxLatexError.cap(5));
      // 			}
      if (rxLineError.indexIn(latexerror) != -1) {
        ...
        errorMessageList.append(
            latexerror.remove(rxLineError).replace("*", ""));
        errorLogList.append(QString::number(errorpar));
      } else {
        if (!filestack.isEmpty())
          errorFileList.append(filestack.last());
      ...
      errorpar = par;
                   ...
                   QRegExp("^(Over|Under)(full \\\\[hv]box .*)"))) {
      badbox = expression.trimmed();
      /*		while (tb.isValid() &&
         !expression.contains(QRegExp("(.*) at line")))
                              {
                              par++;
                              tb=tb.next();
                              if (tb.isValid())
    ...
    for (int i = 0; i < errorFileList.count(); i++) {
      if (errorTypeList.at(i) == "Error") {
        ...
        QTableWidgetItem *ItemLine =
            new QTableWidgetItem("line " + errorLineList.at(i));
        if (fm.width("line  " + errorLineList.at(i)) > maxwidthline)
          maxwidthline = fm.width("line  " + errorLineList.at(i));
        ...
        QTableWidgetItem *ItemMessage =
            new QTableWidgetItem(errorMessageList.at(i));
        if (fm.width(errorMessageList.at(i)) > maxwidth)
          maxwidth = fm.width(errorMessageList.at(i));
...
bool Texmaker::NoLatexErrors() { return onlyErrorList.isEmpty(); }
...
void Texmaker::NextError() {
  ...
  if (logpresent && !onlyErrorList.isEmpty()) {
    if (errorIndex < onlyErrorList.size() - 1)
      errorIndex = errorIndex + 1;
    if (errorIndex < 0)
      errorIndex = 0;
    if (errorIndex >= onlyErrorList.count())
      errorIndex = onlyErrorList.count() - 1;
    if (singlemode) // && onlyErrorList.at(errorIndex)!=0)
    {
      ...
      OutputTableWidget->scrollToItem(Item,
...
void Texmaker::GeneralOptions() {
  ...
  confDlg->ui.comboBoxEncoding->setCurrentIndex(
      confDlg->ui.comboBoxEncoding->findText(input_encoding, Qt::MatchExactly));
  ...
  for (its = shortcuts.begin(); its != shortcuts.end(); ++its) {
    ...
    for (iter = actionstext.begin(); iter != actionstext.end(); ++iter) {
      ...
      if (d == f) {
        ...
        // QTableWidgetItem(*actionstext.find(its.key()));
  ...
  if (confDlg->exec()) {
    ...
    for (int row = 0; row < confDlg->ui.shorttableWidget->rowCount(); row++) {
      ...
      QString itemdata = confDlg->ui.shorttableWidget->item(row, 0)
                             ->data(Qt::UserRole)
                             .toString();
    ...
    if (QColor::isValidColor(confDlg->ui.colortableWidget->item(0, 1)->text()))
      colorBackground =
          QColor(confDlg->ui.colortableWidget->item(0, 1)->text());

    if (QColor::isValidColor(confDlg->ui.colortableWidget->item(1, 1)->text()))
      colorLine = QColor(confDlg->ui.colortableWidget->item(1, 1)->text());

    if (QColor::isValidColor(confDlg->ui.colortableWidget->item(2, 1)->text()))
      colorHighlight = QColor(confDlg->ui.colortableWidget->item(2, 1)->text());

    if (QColor::isValidColor(confDlg->ui.colortableWidget->item(3, 1)->text()))
      colorStandard = QColor(confDlg->ui.colortableWidget->item(3, 1)->text());

    if (QColor::isValidColor(confDlg->ui.colortableWidget->item(4, 1)->text()))
      colorComment = QColor(confDlg->ui.colortableWidget->item(4, 1)->text());

    if (QColor::isValidColor(confDlg->ui.colortableWidget->item(5, 1)->text()))
      colorMath = QColor(confDlg->ui.colortableWidget->item(5, 1)->text());

    if (QColor::isValidColor(confDlg->ui.colortableWidget->item(6, 1)->text()))
      colorCommand = QColor(confDlg->ui.colortableWidget->item(6, 1)->text());

    if (QColor::isValidColor(confDlg->ui.colortableWidget->item(7, 1)->text()))
      colorKeyword = QColor(confDlg->ui.colortableWidget->item(7, 1)->text());

    if (QColor::isValidColor(confDlg->ui.colortableWidget->item(8, 1)->text()))
      colorVerbatim = QColor(confDlg->ui.colortableWidget->item(8, 1)->text());

    if (QColor::isValidColor(confDlg->ui.colortableWidget->item(9, 1)->text()))
      colorTodo = QColor(confDlg->ui.colortableWidget->item(9, 1)->text());

    if (QColor::isValidColor(confDlg->ui.colortableWidget->item(10, 1)->text()))
      colorKeywordGraphic =
          QColor(confDlg->ui.colortableWidget->item(10, 1)->text());

    if (QColor::isValidColor(confDlg->ui.colortableWidget->item(11, 1)->text()))
      colorNumberGraphic =
          QColor(confDlg->ui.colortableWidget->item(11, 1)->text());
    ...
    if (currentEditorView()) {
      LatexEditorView *temp = new LatexEditorView(
          EditorView, EditorFont, svnEnable, showline, edcolors(), hicolors(),
          inlinespellcheck, spell_ignored_words, spellChecker, tabspaces,
          tabwidth, QKeySequence(keyToggleFocus), getName(), userTagsList);
      temp = currentEditorView();
      FilesMap::Iterator it;
      initCompleter();
      for (it = filenames.begin(); it != filenames.end(); ++it) {
        ...
        disconnect(currentEditorView()->editor, SIGNAL(spellme()), this,
                   SLOT(editSpell()));
        disconnect(currentEditorView()->editor, SIGNAL(tooltiptab()), this,
                   SLOT(editTipTab()));
        disconnect(currentEditorView()->editor,
                   SIGNAL(requestUpdateStructure()), this,
                   SLOT(UpdateStructure()));
        disconnect(currentEditorView()->editor, SIGNAL(requestpdf(int)), this,
                   SLOT(jumpToPdfline(int)));
        disconnect(currentEditorView()->editor->document(),
                   SIGNAL(undoAvailable(bool)), UndoAct,
                   SLOT(setEnabled(bool)));
        disconnect(currentEditorView()->editor->document(),
                   SIGNAL(redoAvailable(bool)), RedoAct,
                   SLOT(setEnabled(bool)));
        disconnect(currentEditorView()->editor, SIGNAL(copyAvailable(bool)),
                   CutAct, SLOT(setEnabled(bool)));
        disconnect(currentEditorView()->editor, SIGNAL(copyAvailable(bool)),
                   CopyAct, SLOT(setEnabled(bool)));
        disconnect(currentEditorView()->editor, SIGNAL(numLinesChanged(int)),
                   this, SLOT(refreshAllFromCursor(int)));
        disconnect(currentEditorView()->editor,
                   SIGNAL(requestGotoStructure(int)), this,
                   SLOT(jumpToStructure(int)));
        disconnect(currentEditorView()->editor, SIGNAL(poshaschanged(int, int)),
                   this, SLOT(showCursorPos(int, int)));
        ...
        currentEditorView()->editor->highlighter->activateInlineSpell(
            inlinespellcheck);
        if (wordwrap) {
        ...
        currentEditorView()->editor->setKeyViewerFocus(
            QKeySequence(keyToggleFocus));
        ...
        connect(currentEditorView()->editor, SIGNAL(tooltiptab()), this,
                SLOT(editTipTab()));
        connect(currentEditorView()->editor, SIGNAL(requestUpdateStructure()),
                this, SLOT(UpdateStructure()));
        connect(currentEditorView()->editor, SIGNAL(requestpdf(int)), this,
                SLOT(jumpToPdfline(int)));
        connect(currentEditorView()->editor->document(),
                SIGNAL(undoAvailable(bool)), UndoAct, SLOT(setEnabled(bool)));
        connect(currentEditorView()->editor->document(),
                SIGNAL(redoAvailable(bool)), RedoAct, SLOT(setEnabled(bool)));
        connect(currentEditorView()->editor, SIGNAL(copyAvailable(bool)),
                CutAct, SLOT(setEnabled(bool)));
        connect(currentEditorView()->editor, SIGNAL(copyAvailable(bool)),
                CopyAct, SLOT(setEnabled(bool)));
        currentEditorView()->editor->setLastNumLines(
            currentEditorView()->editor->numoflines());
        connect(currentEditorView()->editor, SIGNAL(numLinesChanged(int)), this,
                SLOT(refreshAllFromCursor(int)));
        connect(currentEditorView()->editor, SIGNAL(requestGotoStructure(int)),
                this, SLOT(jumpToStructure(int)));
        connect(currentEditorView()->editor, SIGNAL(poshaschanged(int, int)),
                this, SLOT(showCursorPos(int, int)));
        // UpdateStructure();
        // UpdateBibliography();
        QApplication::restoreOverrideCursor();
...
void Texmaker::ToggleMode() {
  ...
  if (singlemode && currentEditorView()) {
    ...
    while ((pos = (int)shortName.indexOf('/')) != -1)
      shortName.remove(0, pos + 1);
    ToggleAct->setText(tr("Normal Mode (current master document :") +
                       shortName + ")");
    singlemode = false;
...
void Texmaker::onOtherInstanceMessage(
    const QString &msg) // Added slot for messages to the single instance
{
  ...
  for (int i = 1; i < argc; ++i) {
    ...
    if (arg == "-master")
      ToggleMode();
    if ((arg == "-line") && (i < argc - 1))
      setLine(argv[++i]);
    if (arg == "-insert")
      insertFromCommandLine(argv[++i]);
  }
  // A bad (but applicable) trick for activating Texmaker MainWindow //add by S.
  // R. Alavizadeh setWindowState(Qt::WindowMinimized);
  // setWindowState(windowState() & ~Qt::WindowMinimized | Qt::WindowActive);
  // show();
}
////////////////// VIEW ////////////////
...
void Texmaker::SetMostUsedSymbols() {
  ...
  for (int i = 0; i < 412; i++) {
    ...
    for (int j = i + 1; j < 412; j++) {
      if (list_score.at(j) > list_score.at(max))
        max = j;
    }
    if (max != i) {
      list_num.swap(i, max);
  ...
  for (int i = 0; i <= 11; ++i) {
    if (list_score.at(i) > 0)
      symbolMostused[i] = list_num.at(i);
  }
...
void Texmaker::InsertFavoriteSymbols() {
  ...
  if (action) {
    ...
    int number = -1;
    if (!actData.isEmpty()) {
      if (rxnumber.indexIn(actData) != -1)
        number = rxnumber.cap(1).toInt();
      if (!favoriteSymbolList.contains(number))
        favoriteSymbolList.append(number);
      FavoriteListWidget->SetFavoritePage(favoriteSymbolList);
    }
  }
}
  ...
  if (action) {
    ...
    if (!actData.isEmpty()) {
      if (rxnumber.indexIn(actData) != -1)
        number = rxnumber.cap(1).toInt();
      if (favoriteSymbolList.contains(number))
        favoriteSymbolList.removeOne(number);
      FavoriteListWidget->SetFavoritePage(favoriteSymbolList);
    }
  }
}
...
void Texmaker::UpdateUserTag() {
  ...
  for (int i = 0; i < usertagsListWidget->count(); ++i) {
    tagList.clear();
    data = usertagsListWidget->item(i)->text() + "#" +
           usertagsListWidget->item(i)->data(Qt::UserRole).toString();
    tagList = data.split("#");
    item = "";
    code = "";
    trigger = "";
...
void Texmaker::updateCompleter() {
  ...
  types << QLatin1String("cite") << QLatin1String("nocite")
        << QLatin1String("footcite") << QLatin1String("citep")
        << QLatin1String("ref") << QLatin1String("pageref")
        << QLatin1String("eqref") << QLatin1String("autoref");
  QRegExp macroName("\\\\(" + types.join("|") + ")\\{(.*)\\}",
                    Qt::CaseInsensitive);
  macroName.setMinimal(true);
  ...
  for (int i = 0; i < userCompletionList.count(); ++i) {
    if (userCompletionList.at(i).contains("#bib#"))
      extraBibList.append(userCompletionList.at(i));
    if (userCompletionList.at(i).contains("#label#"))
      extraLabelList.append(userCompletionList.at(i));
  }
...
bool Texmaker::spelldicExist() {
  ...
  QFileInfo fiaff(affdic);
  return (fidic.exists() && fidic.isReadable() && fiaff.exists() &&
          fiaff.isReadable());
}
...
// QMessageBox::information( this,"Texmaker",tr("The appearance setting will
...
void Texmaker::refreshAll() {
  if (!currentEditorView())
    return;
  disconnect(currentEditorView()->editor, SIGNAL(requestUpdateStructure()),
             this, SLOT(UpdateStructure()));
  currentEditorView()->editor->highlighter->rehighlight();
  UpdateStructure();
  connect(currentEditorView()->editor, SIGNAL(requestUpdateStructure()), this,
          SLOT(UpdateStructure()));
}
...
void Texmaker::refreshAllFromCursor(int newnumlines) {
  ...
  for (int i = 0; i < start.count(); i++)
    currentEditorView()->editor->foldedLines.insert(start[i], end[i]);
  ...
  const QList<StructItem>& structure =
  currentEditorView()->editor->getStructItems(); for (int j = 0; j <
  structure.count(); j++)
    {
...
void Texmaker::jumpToStructure(int line) {
  ...
  if (index < 0)
    return;
  QList<QTreeWidgetItem *> fItems = StructureTreeWidget->findItems(
      structure.at(index).item, Qt::MatchRecursive, 0);

  if (fItems.size() > 0) {
    for (int i = 0; i < fItems.size(); i++) {
      if ((fItems.at(i)) && (fItems.at(i)->text(1) == QString::number(index))) {
        StructureTreeWidget->scrollToItem(fItems.at(i),
...
void Texmaker::ToggleStructurePanel() { ShowStructView(true); }
...
void Texmaker::ShowOutputView(bool change) {
  if (change)
    showoutputview = !showoutputview;
  if (showoutputview) {
    Outputframe->show();
    splitter2Changed();
    if (currentEditorView())
      QTimer::singleShot(10, currentEditorView()->editor,
                         SLOT(setCursorVisible()));
  } else {
    Outputframe->hide();
  }
  ViewLogPanelAct->setChecked(showoutputview);
...
void Texmaker::addBibFiles(QString param) {
  ...
  for (int i = 0; i < fl.count(); i++) {
    fname = fl.at(i);
    if (fname.right(4) == ".bib")
      fname = basename + fname;
    else
      fname = basename + fname + ".bib";
    QFileInfo fi(fname);
    if (fi.exists() && fi.isReadable())
      listbibfiles.append(fname);
    else {
      fname = fl.at(i);
      if (fname.right(4) != ".bib")
        fname = fname + ".bib";
...
void Texmaker::showCursorPos(int li, int col) {
  QString linenumber;
  if (col > 0)
    linenumber.sprintf("L: %d C: %d", li, col);
  else
    linenumber.sprintf("L: %d C: %d", li, 1);
...
void Texmaker::TogglePstricks() {
  if (showPstricks) {
    if (LeftPanelToolBar->actions().contains(pstricksAct))
      LeftPanelToolBar->removeAction(pstricksAct);
  } else if (!LeftPanelToolBar->actions().contains(pstricksAct))
    LeftPanelToolBar->addAction(pstricksAct);
  showPstricks = !showPstricks;
}
void Texmaker::ToggleMetapost() {
  if (showMp) {
    if (LeftPanelToolBar->actions().contains(mpAct))
      LeftPanelToolBar->removeAction(mpAct);
  } else if (!LeftPanelToolBar->actions().contains(mpAct))
    LeftPanelToolBar->addAction(mpAct);
  showMp = !showMp;
}
void Texmaker::ToggleTikz() {
  if (showTikz) {
    if (LeftPanelToolBar->actions().contains(tikzAct))
      LeftPanelToolBar->removeAction(tikzAct);
  } else if (!LeftPanelToolBar->actions().contains(tikzAct))
    LeftPanelToolBar->addAction(tikzAct);
  showTikz = !showTikz;
}
void Texmaker::ToggleAsymptote() {
  if (showAsy) {
    if (LeftPanelToolBar->actions().contains(asyAct))
      LeftPanelToolBar->removeAction(asyAct);
  } else if (!LeftPanelToolBar->actions().contains(asyAct))
    LeftPanelToolBar->addAction(asyAct);
  showAsy = !showAsy;
}
...
void Texmaker::ToggleEmphasis() {
  if (showEmphasis) {
    if (centralToolBar->actions().contains(emphasisAct))
      centralToolBar->removeAction(emphasisAct);
  } else if (!centralToolBar->actions().contains(emphasisAct))
    centralToolBar->addAction(emphasisAct);
...
void Texmaker::ToggleNewline() {
  if (showNewline) {
    if (centralToolBar->actions().contains(newlineAct))
      centralToolBar->removeAction(newlineAct);
  } else if (!centralToolBar->actions().contains(newlineAct))
    centralToolBar->addAction(newlineAct);
...
void Texmaker::ToggleMathmode() {
  if (showMathmode) {
    if (centralToolBar->actions().contains(mathmodeAct))
      centralToolBar->removeAction(mathmodeAct);
  } else if (!centralToolBar->actions().contains(mathmodeAct))
    centralToolBar->addAction(mathmodeAct);
...
void Texmaker::ToggleIndice() {
  if (showIndice) {
    if (centralToolBar->actions().contains(indiceAct))
      centralToolBar->removeAction(indiceAct);
  } else if (!centralToolBar->actions().contains(indiceAct))
    centralToolBar->addAction(indiceAct);
...
void Texmaker::TogglePuissance() {
  if (showPuissance) {
    if (centralToolBar->actions().contains(puissanceAct))
      centralToolBar->removeAction(puissanceAct);
  } else if (!centralToolBar->actions().contains(puissanceAct))
    centralToolBar->addAction(puissanceAct);
...
void Texmaker::ToggleSmallfrac() {
  if (showSmallfrac) {
    if (centralToolBar->actions().contains(smallfracAct))
      centralToolBar->removeAction(smallfracAct);
  } else if (!centralToolBar->actions().contains(smallfracAct))
    centralToolBar->addAction(smallfracAct);
...
void Texmaker::ToggleDfrac() {
  if (showDfrac) {
    if (centralToolBar->actions().contains(dfracAct))
      centralToolBar->removeAction(dfracAct);
  } else if (!centralToolBar->actions().contains(dfracAct))
    centralToolBar->addAction(dfracAct);
  showDfrac = !showDfrac;
}
...
void Texmaker::ToggleRacine() {
  if (showRacine) {
    if (centralToolBar->actions().contains(racineAct))
      centralToolBar->removeAction(racineAct);
  } else if (!centralToolBar->actions().contains(racineAct))
    centralToolBar->addAction(racineAct);
...
void Texmaker::splitter2Changed() {
  QFontMetrics fm(qApp->font());
  if (OutputTableWidget->isVisible())
    OutputTextEdit->setMaximumHeight(5 * (fm.lineSpacing() + 4));
  else {
    if (splitter2->sizes().at(1) > 0)
      OutputTextEdit->setMaximumHeight(splitter2->sizes().at(1));
    else
      OutputTextEdit->setMaximumHeight(splitter2->sizes().at(0));
  }
}
    ...
    for (itf = filenames.begin(); itf != filenames.end(); ++itf) {
      ...
      if (!docname.startsWith("untitled")) {
        ...
        element.setAttribute(
            "line",
            QString::number(itf.key()->editor->textCursor().blockNumber()));
        element.setAttribute(
            "bookmark1", QString::number(itf.key()->editor->UserBookmark[0]));
        element.setAttribute(
            "bookmark2", QString::number(itf.key()->editor->UserBookmark[1]));
        element.setAttribute(
            "bookmark3", QString::number(itf.key()->editor->UserBookmark[2]));
        if ((!singlemode) && (MasterName == docname))
          element.setAttribute("master", "true");
        else
          element.setAttribute("master", "false");
        if (itf.key() == currentEditorView())
          element.setAttribute("hasfocus", "true");
        else
          element.setAttribute("hasfocus", "false");
  ...
  while (!element.isNull()) {
    ...
    if (element.hasAttribute("file")) {
      ...
      if (element.hasAttribute("line"))
        l = element.attribute("line").toInt();
      if (element.hasAttribute("bookmark1"))
        b1 = element.attribute("bookmark1").toInt();
      if (element.hasAttribute("bookmark2"))
        b2 = element.attribute("bookmark2").toInt();
      if (element.hasAttribute("bookmark3"))
        b3 = element.attribute("bookmark3").toInt();
      if (element.hasAttribute("master"))
        ma = (element.attribute("master") == "true");
      if (element.hasAttribute("hasfocus"))
        fo = (element.attribute("hasfocus") == "true");
      if (fo) {
        ofile = file;
        ol = l;
        ob1 = b1;
  ...
  for (itf = filenames.begin(); itf != filenames.end(); ++itf) {
    ...
    if (!docname.startsWith("untitled")) {
      ...
      element.setAttribute(
          "line",
          QString::number(itf.key()->editor->textCursor().blockNumber()));
      element.setAttribute("bookmark1",
                           QString::number(itf.key()->editor->UserBookmark[0]));
      element.setAttribute("bookmark2",
                           QString::number(itf.key()->editor->UserBookmark[1]));
      element.setAttribute("bookmark3",
                           QString::number(itf.key()->editor->UserBookmark[2]));
      if ((!singlemode) && (MasterName == docname))
        element.setAttribute("master", "true");
      else
        element.setAttribute("master", "false");
  ...
  while (!element.isNull()) {
    ...
    if (element.hasAttribute("file")) {
      ...
      if (element.hasAttribute("master"))
        ma = (element.attribute("master") == "true");
      if (element.hasAttribute("hasfocus"))
        fo = (element.attribute("focus") == "true");
      if (fo) {
        ofile = file;
        ol = l;
        ob1 = b1;
