...
void GraphicFileChooser::setDir(const QString &di) { dir = di; }

void GraphicFileChooser::setFilter(const QString &fil) { filter = fil; }
QString GraphicFileChooser::fileName() const { return ui.lineEdit->text(); }
