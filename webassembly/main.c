...
const char *ptexbanner = " (XeTeX WebAssembly Build 0.22)";
const char *DEFAULT_FMT_NAME = " swiftlatex22p.fmt";
const char *DEFAULT_DUMP_NAME = "swiftlatex22p";
string versionstring = " (XeTeX WebAssembly 0.22 beta)";
