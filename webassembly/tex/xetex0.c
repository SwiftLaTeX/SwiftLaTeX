...
zcopynativeglyphinfo ( halfword src , halfword dest ) 
{
  ...
  integer glyphcount, textcount  ;
  mem [dest + 6 ].ptr = nullptr ;
  if ( mem [src + 6 ].ptr != nullptr ) 
  {
    textcount = mem [src + 4 ].qqqq .b2 ;
    mem [dest + 6 ].ptr = xmalloc ( textcount * sizeof ( longword ) ) ;
    memcpy ( mem [dest + 6 ].ptr , mem [src + 6 ].ptr , textcount * sizeof 
    ( longword ) ) ;
    mem [dest + 4 ].qqqq .b2 = textcount ;
  } 
  ...
  while ( p != -268435455L ) {
      ...
      case 8 : 
	{
	  ...
	  case 41 : 
		...
		if ( mem [p + 6 ].ptr != nullptr ) 
		{
		  libcfree ( mem [p + 6 ].ptr ) ;
		  mem [p + 6 ].ptr = nullptr ;
		} 
	      } 
...
unsave ( void ) 
{
  ...
  if ( curlevel > 1 ) 
  {
	...
	t = curtok ;
	curtok = p ;
	curchrsig = savestack [saveptr ].hh .me ;
	if ( a ) 
	{
	  p = getavail () ;
...
znewnativewordnode ( internalfontnumber f , integer n ) 
{
  ...
  integer l  ;
  halfword q  ;
  l = 7 + ( n * sizeof ( UTF16code ) + sizeof ( memoryword ) - 1 ) / sizeof ( 
  memoryword ) ;
  q = getnode ( l ) ;
  mem [q ].hh.b0 = 8 ;
  ...
  mem [q + 4 ].qqqq .b3 = 0 ;
  mem [q + 5 ].ptr = nullptr ;
  mem [q + 6 ].ptr = xmalloc ( n * sizeof ( longword ) ) ;
  Result = q ;
  return Result ;
} 
halfword 
znewnativecharacter ( internalfontnumber f , UnicodeScalar c ) 
{
  ...
  if ( fontmapping [f ]!= 0 ) 
  {
    ...
    mem [p + 6 ].ptr = xmalloc ( mem [p + 4 ].qqqq .b2 * sizeof ( longword 
    ) ) ;
  } 
...
zdolocalelinebreaks ( integer s , integer len ) 
{
  ...
  if ( ( eqtb [8939308L ].cint == 0 ) || ( len == 1 ) ) 
  {
	...
	setnativecharsig ( curlist .tailfield , i , taggedsig [s + i ]) ;
      } 
    while ( i++ < for_end ) ;} 
	...
	<= for_end) do 
	  {
	    ...
	    + i ]) ;
	    setnativecharsig ( curlist .tailfield , i - prevOffs , taggedsig [
	    s + i ]) ;
	  } 
	while ( i++ < for_end ) ;} 
	setnativemetrics ( curlist .tailfield , ( eqtb [8939314L ].cint > 0 
...
zdvifontdef ( internalfontnumber f ) 
{
  ...
  dvinativefontdef ( f ) ;
    ...
    htmltexfontout ( f , fontsize [f ], fontdsize [f ]) ;
...
zspecialout ( halfword p ) 
{
  ...
  htmlspecialout ( ( poolptr - strstart [( strptr ) - 65536L ]) , strstart [
  ( strptr ) - 65536L ]) ;
...
zpicout ( halfword p ) 
{
  ...
  htmlpicout ( mem [p + 3 ].cint , mem [p + 1 ].cint , p ) ;
  oldsetting = selector ;
  selector = 21 ;
  print ( 66772L ) ;
  print ( 66773L ) ;
...
hlistout ( void ) 
{
  ...
  while ( p != -268435455L ) lab21: if ( ( p >= himemmin ) ) 
  {
	...
	case 42 : 
	  {
		...
		if ( nopdfoutput ) 
		{
	      ...
	      htmlnativeglyphout ( mem [p + 4 ].qqqq .b2 , f , p ) ;
	      curh = curh + mem [p + 1 ].cint ;
	    } 
	    else {
		  ...
		  k <= for_end) do 
		    {
		      ...
		      htmlnativecharout ( getnativechar ( p , k ) , f , 
		      getnativecharsig ( p , k ) ) ;
		    } 
		  while ( k++ < for_end ) ;} 
	...
	dviv = curv ;
      ...
      htmlruleout ( 0 , ruledp , rulewd , ruleht ) ;
      {
	if ( nopdfoutput ) 
	{
	  dvibuf [dviptr ]= 132 ;
...
vlistout ( void ) 
{
  ...
  while ( p != -268435455L ) {
	...
	htmlruleout ( 1 , ruledp , rulewd , ruleht ) ;
	{
	  if ( nopdfoutput ) 
	  {
	    dvibuf [dviptr ]= 137 ;
		...
		do {
		  ...
		  {register integer for_end; k = 0 ;for_end = mem [ppp + 4 
		  ].qqqq .b2 - 1 ; if ( k <= for_end) do 
		    {
		      ...
		      k ) ) ;
		      setnativecharsig ( pp , totalchars , getnativecharsig ( 
		      ppp , k ) ) ;
		      incr ( totalchars ) ;
		    } 
		  while ( k++ < for_end ) ;} 
...
zmakemathaccent ( halfword q ) 
{
  ...
  if ( x != -268435455L ) 
  {
    ...
    if ( ( ( fontarea [f ]== 65535L ) || ( fontarea [f ]== 65534L ) ) ) 
    {
      ...
      setnativeglyphmetrics ( p , 1 ) ;
      {
	if ( mem [mem [y + 5 ].hh .v.RH + 5 ].ptr != nullptr ) 
	{
	  libcfree ( mem [mem [y + 5 ].hh .v.RH + 5 ].ptr ) ;
	  mem [mem [y + 5 ].hh .v.RH + 5 ].ptr = nullptr ;
	  mem [mem [y + 5 ].hh .v.RH + 4 ].qqqq .b3 = 0 ;
	} 
	if ( mem [mem [y + 5 ].hh .v.RH + 6 ].ptr != nullptr ) 
	{
	  libcfree ( mem [mem [y + 5 ].hh .v.RH + 6 ].ptr ) ;
	  mem [mem [y + 5 ].hh .v.RH + 6 ].ptr = nullptr ;
	} 
      } 
...
mlisttohlist ( void ) 
{
  ...
  while ( q != -268435455L ) {
	...
	65534L ) ) ) 
	{
	  ...
	  setnativeglyphmetrics ( p , 1 ) ;
	  {
	    if ( mem [z + 5 ].ptr != nullptr ) 
	    {
	      libcfree ( mem [z + 5 ].ptr ) ;
	      mem [z + 5 ].ptr = nullptr ;
	      mem [z + 4 ].qqqq .b3 = 0 ;
	    } 
	    if ( mem [z + 6 ].ptr != nullptr ) 
	    {
	      libcfree ( mem [z + 6 ].ptr ) ;
	      mem [z + 6 ].ptr = nullptr ;
	    } 
	  } 
...
hyphenate ( void ) 
{
  ...
  41 ) ) ) ) ) 
  {
	  ...
	  ; if ( i <= for_end) do 
	    {
	      ...
	      setnativecharsig ( q , i , getnativecharsig ( ha , i + 
	      hyphenpassed ) ) ;
	    } 
	  while ( i++ < for_end ) ;} 
    ...
    i <= for_end) do 
      {
	setnativechar ( q , i , getnativechar ( ha , i + hyphenpassed ) ) ;
	setnativecharsig ( q , i , getnativecharsig ( ha , i + hyphenpassed ) 
	) ;
      } 
    while ( i++ < for_end ) ;} 
    setnativemetrics ( q , ( eqtb [8939314L ].cint > 0 ) ) ;
  ...
  case 9 : 
	...
	if ( mem [p ].hh .v.RH == -268435455L ) {
	  ...
	  if ( mem [p ].hh.b0 == 16 ) 
	  {
		...
		.hh ;
		mem [savestack [saveptr + 0 ].cint ].hh .me = mem [p ]
		.hh .me ;
		freenode ( p , 4 ) ;
	      } 
	    } 
...
maincontrol ( void ) 
{
  ...
  [eqtb [2253799L ].hh .v.RH ]== 65534L ) ) ) 
  {
	...
	UTF16code ) ) ;
	taggedsig = xrealloc ( taggedsig , nativetextsize * sizeof ( longword 
	) ) ;
      } 
      {
	...
	incr ( nativelen ) ;
      ...
      {
	taggedsig [nativelen - 1 ]= curchrsig ;
      } 
      {
	...
	himemmin ) ) && ( mem [mainppp ].hh.b0 != 7 ) ) 
	{
	  ...
	  while ( nativetextsize <= nativelen + maink ) {
	    ...
	    nativetext = xrealloc ( nativetext , nativetextsize * sizeof ( 
	    UTF16code ) ) ;
	    taggedsig = xrealloc ( taggedsig , nativetextsize * sizeof ( 
	    longword ) ) ;
	  } 
	  ...
	  .qqqq .b2 - 1 ; if ( mainp <= for_end) do 
		...
		incr ( nativelen ) ;
	      ...
	      {
		taggedsig [nativelen - 1 ]= getnativecharsig ( mainpp , 
		mainp ) ;
	      } 
	    } 
	  while ( mainp++ < for_end ) ;} 
	  ...
	  mainp <= for_end) do 
		...
		incr ( nativelen ) ;
	      ...
	      {
		taggedsig [nativelen - 1 ]= taggedsig [tempptr + mainp ];
	      } 
	    } 
	  while ( mainp++ < for_end ) ;} 
	...
	.qqqq .b2 - 1 ; if ( mainp <= for_end) do 
	  {
	    setnativechar ( curlist .tailfield , mainp , getnativechar ( 
	    mainpp , mainp ) ) ;
	    setnativecharsig ( curlist .tailfield , mainp , getnativecharsig ( 
	    mainpp , mainp ) ) ;
	  } 
	while ( mainp++ < for_end ) ;} 
	...
	mainp <= for_end) do 
	  {
	    ...
	    setnativecharsig ( curlist .tailfield , mainp + mem [mainpp + 4 ]
	    .qqqq .b2 , taggedsig [mainp ]) ;
	  } 
	while ( mainp++ < for_end ) ;} 
	setnativemetrics ( curlist .tailfield , ( eqtb [8939314L ].cint > 0 
	) ) ;
	...
	mainp <= for_end) do 
	  {
	    ...
	    setnativecharsig ( curlist .tailfield , mainp , taggedsig [mainp 
	    ]) ;
	  } 
	while ( mainp++ < for_end ) ;} 
	setnativemetrics ( curlist .tailfield , ( eqtb [8939314L ].cint > 0 
	...
	if ( ( mem [mainpp + 4 ].qqqq .b1 == mainf ) ) 
	{
	  ...
	  if ( ! ( mainp >= himemmin ) && ( mem [mainp ].hh.b0 == 10 ) ) 
	  {
	      ...
	      .qqqq .b2 - 1 ; if ( t <= for_end) do 
		{
		  ...
		  setnativecharsig ( tempptr , maink , getnativecharsig ( 
		  mainpp , t ) ) ;
		  incr ( maink ) ;
		} 
	      while ( t++ < for_end ) ;} 
	      ...
	      .tailfield + 4 ].qqqq .b2 - 1 ; if ( t <= for_end) do 
		{
	      ...
	      {
		if ( mem [tempptr + 5 ].ptr != nullptr ) 
		{
		  libcfree ( mem [tempptr + 5 ].ptr ) ;
		  mem [tempptr + 5 ].ptr = nullptr ;
		  mem [tempptr + 4 ].qqqq .b3 = 0 ;
		} 
		if ( mem [tempptr + 6 ].ptr != nullptr ) 
		{
		  libcfree ( mem [tempptr + 6 ].ptr ) ;
		  mem [tempptr + 6 ].ptr = nullptr ;
		} 
	      } 
